...
/*
  ...
  /*
   ...
   val ddot = Module(new FP_DDOT_dp_complex(bw/2,streaming_width)).io
   ...
   for(i <- 0 until streaming_width ){ 
    ...
    val hqr3 = Module(new FP_square_root_newfpu(bw/2,3)).io//stays the same for complex
    hqr3.in_en := true.B
    hqr3.in_a := d1
...
*/
   ...
   val hqr5= Module(new hqr5_complex(bw/2)).io
   ...
   val hqr7= Module(new hqr7(bw/2)).io
   hqr7.in_a := d3
...
/*
   ...
   */
   ...
   val hqr10= Module(new FPComplexMult_v2(bw/2)).io//changes made for complex
   hqr10.in_en := true.B
   ...
   val axpy= Module(new axpy_dp_complex(bw/2,streaming_width)).io
